...
BOOLEAN RtlStringContains(CONST CHAR* InString, CHAR InSearchedCharacter, BOOLEAN InCaseInsensitive = FALSE);
...
/// <param name="InSearchedCharacter">The character to find.</param>
/// <param name="InCaseInsensitive">Whether to check the casing of the character or not.</param>
BOOLEAN RtlStringContains(CONST WCHAR* InString, WCHAR InSearchedCharacter, BOOLEAN InCaseInsensitive = FALSE);
